<template>
  ...
  <div class="profile-card js-profile-card">
    <!-- <div class="profile-card__img" v-if="users.profile_image">
      <img :src="'images/profile/'+users.profile_image" alt="profile card">
      <img :src="'images/profile/profile.png'" alt="profile card">
    </div> -->
    ...
    <div class="profile-cards">
      ...
      <div class="profile-card-inf">
        <div class="profile-card-inf__item" style="width: 100%;">

          <div class="profile-card-inf__title" style="text-align: left; margin-bottom: 10px;">GENERAL</div>
...
.wrapper {
  ...
  padding-top: 100px;
  display: flex;
  background-image: linear-gradient(-20deg, #e3342f 0%, #fff000 100%);
...
.profile-card {
  ...
  .profile-cards {
    width: 100%;
    margin: auto;
    box-shadow: 0px 10px 40px -10px #2c2a06eb;
    background: #fff000;
    border-radius: 12px;
    max-width: 700px;
    position: relative;
  ...
  .profile-card-sub {
    margin: auto;
    box-shadow: 10px 10px 20px -12px #2c2a06eb;
    background: #e5e4de;
    border-radius: 12px;
    width: 100%;
    position: relative;
