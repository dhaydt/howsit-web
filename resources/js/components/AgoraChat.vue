    ...
    <div class="Vcall">
        <div class="call-frame">
            ...
            <div class="row rowss">
                ...
                <div class="contact-list  custom-scrollbar-js p-2" id="content-2">
                    <li class="" v-for="user in allusers" :key="user.id">
                        <div class="status">
                        ...
                        <div class="call-button">
                            <a @click="placeCall(user.id, user.name)" class="v-btn">
            ...
            <div class="landing-vc col-sm d-none d-lg-block">
                <div class="landing">
                <i class="bi bi-camera-video-fill"></i>
                <h2>Video Call</h2>
