    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Shares update</h5>
            ...
            <form action="/shares/{{ $share->id }}" method="POST" id="editShare" name="bene" oninput="calculate()">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="">Old Shares</label>
                        <h5 class="my-0">
                            USD
                            <input id="edit-share" class="wallet-balance-per-date"
                                style="border: none; background-color: transparent;" name="oldshare">
                        </h5>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="">New Shares</label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <div class="input-group-text">USD</div>
                            </div>
                            <input type="number" name="share" id="newshare" class="form-control share" readonly>
                        </div>
                    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        table.on('click', '.edit', function() {
            ...
            $('#edit-share').val(data[3]);
            $('#edit-id').val(data[1]);

            $('#editShare').attr('action', '/shares/'+data[1]);
